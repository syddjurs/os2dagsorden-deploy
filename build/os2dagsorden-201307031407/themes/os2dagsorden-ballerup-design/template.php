 ...
 * @return none
 */
function balkdags_preprocess_page(&$variables) 
{    
    drupal_add_js(drupal_get_path('theme', 'balkdags') . '/js/balkdags.js');
	...
	global $user, $base_path;	
        if ($view->name == 'meeting_details') {
            ...
            //adding pagescroll
	    drupal_add_css(drupal_get_path('theme', 'balkdags') . '/css/pagescroller.skins.css');	    
	    drupal_add_js(drupal_get_path('theme', 'balkdags') . '/js/jquery.pagescroller.js');
 ...
 */
function balkdags_date_nav_title($params) 
{
 ...
 * @return reformatted title
 */
function balkdags_calendar_time_row_heading($vars) 
{
 ...
 * @return none
 */
function balkdags_form_alter(&$form, &$form_state) {
 ...
 * @return none
 */
function balkdags_preprocess_html(&$vars) {
...
function balkdags_menu_local_task($variables) {
